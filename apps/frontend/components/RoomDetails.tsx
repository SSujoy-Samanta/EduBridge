...
export const RoomDetails=({name,passkey,roomId,userId,setGroupCreated}:{
    ...
    return <div className="flex xl:w-4/6 md:w-4/6 xxs:w-full w-3/4 p-2 gap-2 items-center border rounded-md border-zinc-800 hover:bg-slate-800 sm2:text-base xxs:text-xs">
