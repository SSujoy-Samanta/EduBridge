...
export const  ShowData=({user}:{
    ...
    return <div className=" flex gap-2 p-2 items-center border rounded-md border-neutral-800 justify-between hover:bg-gray-900 cursor-pointer xl:text-base md:text-sm xxs:text-xs sm2:flex-col xxs:flex-row xxs:justify-center sm:flex-row w-full">
        <div className="flex gap-2 w-full sm:h-full xxs:h-24 ">
            <div className="flex justify-center items-center w-full h-full xxs:w-2/6  sm:w-1/6">
                <div className="flex justify-center items-center border rounded-md border-neutral-800 bg-slate-800 text-rose-700 w-full h-full text-3xl">{name.toUpperCase()[0]}</div>
                </div>
        ...
        <div className="flex flex-col p-2 gap-2 w-1/6 items-center">
            ...
            }}><p className="sm:text-sm xxs:text-xs">view</p></PrimaryButton>
