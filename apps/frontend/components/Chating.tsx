...
export const Chating = ({ userId, room }: { userId: number; room: string }) => {
  ...
  return (
    <div className='w-full flex justify-evenly mb-2'>
      <div className="text-white bg-cyan-500 lg:w-3/5 md:w-5/6 xxs:w-11/12 flex flex-col p-3 border rounded-md border-teal-700 gap-1">
        <div className="flex justify-between items-center">
          ...
          <div className='flex gap-1'>
            <button className='border p-1 rounded-md border-green-900 bg-green-600 flex justify-start items-center  lg:hidden' onClick={()=>{
              setGroup(x=>!x);
            }}>
      ...
      <div className={`lg:w-1/5 xxs:w-5/6 sm:w-4/6 xxs:top-24 lg:block ${group ? 'xxs:absolute' : 'xxs:hidden'} border-2 border-cyan-900 rounded-md p-2 overflow-auto bg-black`}>
