...
export const Room=({ userId, initialUserRooms }: { userId: number, initialUserRooms: UserRoom[] })=>{
    ...
    return <div className="flex gap-2 p-3 w-full h-full justify-center items-center flex-col  ">
        <div className='flex justify-center items-center w-full'>
            <div className='w-full flex justify-center items-start gap-1'>
                <div className='flex flex-col gap-2 justify-center items-center w-full '>
                    <button onClick={()=>{setGroup(true)}} className='rounded-md bg-green-600 p-2 2xl:w-1/3 hover:bg-green-700 transition md:w-4/6 lg:w-2/4 sm2:w-full sm:text-base sm2:text-sm xxs:text-xs xxs:w-1/2'>
                    ...
                    {
                        group && <div className='flex bg-slate-800  items-end gap-2 border border-slate-800 p-2 rounded-md absolute top-16 left-3  mx-4 z-10'>
                ...
                <div className='flex flex-col gap-2 justify-center items-center w-full'>
                    <button onClick={()=>{setJoin(true)}} className='rounded-md bg-blue-600 p-2 w-1/3 hover:bg-blue-700 transition 2xl:w-1/3 lg:w-2/4 md:w-4/6 sm2:w-full xxs:w-1/2 sm:text-base sm2:text-sm xxs:text-xs'>
                        <div className="flex justify-center items-center gap-2 ">
                            <div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="size-6">
                    ...
                    {
                        Join && <div className='flex bg-slate-800  items-end gap-2 border border-slate-800 p-2 rounded-md absolute top-16 left-3/6 mx-4 z-10'>
                ...
                <div className='flex flex-col gap-2 justify-center items-center w-full '>
                    <button className='rounded-md bg-sky-600 p-2 w-1/3 hover:bg-sky-700 transition text-black lg:w-2/4 md:w-4/6 sm2:w-full xxs:w-1/2 2xl:w-1/3 sm:text-base sm2:text-sm ' onClick={()=>{
                        ...
                        <div className="flex justify-center items-center gap-2 ">
                            ...
                            <p className="text-black sm2:block xxs:hidden ">Start Metting</p>
                        </div>
        ...
        <div className='xl:w-3/6 md:w-4/6 xxs:w-full flex flex-col gap-2 items-center border rounded m-4 p-2 min-h-3.5 border-teal-800 overflow-auto'>
            {
